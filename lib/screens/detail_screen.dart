...
import 'package:flutter_aplikasi_surah_test/models/ayat.dart';
import 'package:flutter_aplikasi_surah_test/models/surah.dart';
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: blues, borderRadius: BorderRadius.circular(10)),
              child: Row(
                children: [
                  Container(
                    width: 27,
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Divider(
                  color: const Color(0xFF121931).withOpacity(.35),
                  thickness: 2,
                  height: 32,
                ),
                Row(
